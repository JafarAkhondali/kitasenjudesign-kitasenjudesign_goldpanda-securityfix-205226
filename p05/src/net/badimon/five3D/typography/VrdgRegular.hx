 ...
 * @author watanabe
 */
class VrdgRegular extends Typography3D
{
	private static var _instance:VrdgRegular;
	...
	override public function getHeight(char:String):Float {

		/*
		if (char == "ウ" || char == "ス" || char == "デ" || char == "マ" ) {
			return 148;
		}*/
