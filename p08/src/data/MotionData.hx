...
class MotionData
{
	...
	public static inline var MODE_ONE:Int = 0;
	public static inline var MODE_MULTI:Int = 1;
	...
	public static var XYR3:MotionData = new MotionData( 0.25, 0.25, -0.5 );
	public static var XYR4:MotionData = new MotionData( -0.2, 0.2, -0.5 );
