...
Maps.prototype = {
	...
	,_onRemove: function(tgt) {
		Tracer.debug("remove num->" + this._maps.length);
...
ModuleMap.prototype = {
	...
	,setMoji: function(moji) {
		...
		new js.JQuery(this._id + " .title").text(this._data.title);
		new js.JQuery(this._id + " .google").text("earthview.withgoogle.com");
